...
private:
    ...
    void create_texture_image() {
        ...
        stbi_uc* pixels = stbi_load("textures/check_texture.png", &tex_width, &tex_height, &tex_channels, STBI_rgb_alpha);
    ...
    void update_uniform_buffer(uint32_t current_image) {
        ...
        ubo.model = glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 0.0f, -5.0f)) * glm::scale(glm::mat4(1.0f), glm::vec3(0.2f, 0.2f, 1.0f));
